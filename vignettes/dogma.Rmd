...
A valuable function to add would be a transription() function, which would take a DNA sequence and create a complementary RNA sequence, based on the base pairing rules (A:U, T:A, G:C, C:G).
